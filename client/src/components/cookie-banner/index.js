    ...
    <div className="cookie-banner">
      <div className="cookie-banner__container">
        ...
        <div className="cookie-banner__ctas">
          <button className="cookie-banner__cta" onClick={() => {props.giveCookieConsentResponse(false)}}>no</button>
          <button className="cookie-banner__cta" onClick={() => {props.giveCookieConsentResponse(true)}}>yes</button>
          {
            !shouldDisplayCookieExplanation &&
